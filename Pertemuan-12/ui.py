...
if 'google_maps' not in st.session_state:
    ...
    g.add_edge("Kampus UIN", "Stasiun Parujakan", 5)
    g.add_edge("Stasiun Parujakan", "Mall CSB", 3)
...
with col_map:
    ...
    if len(G.nodes) > 0:
        ...
        # Gambar Node & Label
        nx.draw(G, pos, with_labels=True, node_color="#3C35FF", node_size=2500, 
                font_size=10, font_color="white", font_weight="bold", 
                edge_color="pink", width=3, ax=ax)
